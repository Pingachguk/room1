...
def get_clubs():
    ...
    return clubs
    """
    result = [{"id":"bf1e201a-01c3-11eb-bbdb-005056838e97","name":"СПб, пр-т Маршала Блюхера, д.6, к.2","address":"СПб, пр-т Маршала Блюхера, д.6, к.2","city_code":None,"city":None},{"id":"a23e2522-e7ad-11ea-bbd8-005056838e97","name":"СПб, В.О наб.реки Смоленки, д.3, к.1, ЖК \"Самоцветы\"","address":"СПб, В.О наб.реки Смоленки, д.3, к.1, ЖК \"Самоцветы\"","city_code":None,"city":None},{"id":"e64f0bc2-0652-11eb-bbdb-005056838e97","name":"СПб, Выборгское шоссе д.17, к.1 ЖК \"Шуваловские высоты\"","address":"СПб, Выборгское шоссе д.17, к.1 ЖК \"Шуваловские высоты\"","city_code":None,"city":None},{"id":"22bd71b4-e7af-11ea-bbd8-005056838e97","name":"СПб, Загребский бульвар, д.9, ЖК \"Радуга\"","address":"СПб, Загребский бульвар, д.9, ЖК \"Радуга\"","city_code":None,"city":None},{"id":"d987364c-e7ae-11ea-bbd8-005056838e97","name":"СПб, Кудрово, Каштановая аллея, д.2","address":"СПб, Кудрово, Каштановая аллея, д.2","city_code":None,"city":None},{"id":"630de9d9-e7ae-11ea-bbd8-005056838e97","name":"СПб, Лыжный переулок, д.2","address":"СПб, Лыжный переулок, д.2","city_code":None,"city":None},{"id":"cb28be84-0651-11eb-bbdb-005056838e97","name":"МСК, 3-й Донской проезд, д.1","address":"МСК, 3-й Донской проезд, д.1","city_code":None,"city":None},{"id":"39158ee8-e79e-11ea-bbd8-005056838e97","name":"СПб, пр-т Московский, д.183-185, ЖК \"Граф Орлов\"","address":"СПб, пр-т Московский, д.183-185, ЖК \"Граф Орлов\"","city_code":None,"city":None},{"id":"d2c3b3d6-e7ad-11ea-bbd8-005056838e97","name":"СПб, ул. Ждановская, д.43, к.1, ЖК \"Премьер Палас\"","address":"СПб, ул. Ждановская, д.43, к.1, ЖК \"Премьер Палас\"","city_code":None,"city":None},{"id":"37948207-e7ae-11ea-bbd8-005056838e97","name":"СПб, пр-т Маршала Блюхера, д.9, к.1, ЖК \"Фламинго\"","address":"СПб, пр-т Маршала Блюхера, д.9, к.1, ЖК \"Фламинго\"","city_code":None,"city":None},{"id":"64b8476a-e7ad-11ea-bbd8-005056838e97","name":"СПб, пр-т Юрия Гагарина, д.7 ЖК \"Космос\"","address":"СПб, пр-т Юрия Гагарина, д.7 ЖК \"Космос\"","city_code":None,"city":None},{"id":"d987364c-e7ae-11ea-bbd8-005056838e97","name":"СПб, Кудрово, Каштановая аллея, д.2","address":"СПб, Кудрово, Каштановая аллея, д.2","city_code":None,"city":None},{"id":"915d3c3b-daff-11ea-bbd8-005056838e97","name":"СПб, Пушкин, Московское шоссе, 34","address":"СПб, Пушкин, Московское шоссе, 34","city_code":None,"city":None},{"id":"603cb73d-e7af-11ea-bbd8-005056838e97","name":"СПб, ул. Дыбенко,д.8, к.3, ЖК \"Ренессанс\"","address":"СПб, ул. Дыбенко,д.8, к.3, ЖК \"Ренессанс\"","city_code":None,"city":None},{"id":"42632fd3-e7af-11ea-bbd8-005056838e97","name":"СПб, ул. Красного Текстильщика, д.7","address":"СПб, ул. Красного Текстильщика, д.7","city_code":None,"city":None},{"id":"15281aec-07c8-11eb-bbdb-005056838e97","name":"САМАРА, Парковый переулок, 5","address":"САМАРА, Парковый переулок, 5","city_code":None,"city":None},{"id":"b9ea102a-0ec0-11eb-bbdb-005056838e97","name":"МСК, д.Путилково ул.Новотушинская д.2","address":"МСК, д.Путилково ул.Новотушинская д.2","city_code":None,"city":None},{"id":"129d154c-0ec1-11eb-bbdb-005056838e97","name":"МСК, ул.Автозаводская д.23Б","address":"МСК, ул.Автозаводская д.23Б","city_code":None,"city":None}]
